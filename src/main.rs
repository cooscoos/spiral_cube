...
fn main(){
    ...
    // The hex number in spiral coords
    let spiral = 5;
    println!("{} in spiral coords is the same as {:?} in cube coords", spiral, spiral_to_cube(spiral))
}
...
fn spiral_to_cube(x: usize) -> (i8,i8,i8) {
    ...
    let ring_offset = ring_offset(x) as f32;
